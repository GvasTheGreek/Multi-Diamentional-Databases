...
""" A  function to get the sum of values in the given array. The following are parameters for this function.  
    ...
    query_start & query_end  --> Starting and ending indexes of query range """                 # qs    # qe
...
# A recursive function that constructs Segment Tree for array[ss..se] si is index of current node in segment tree seg_tree_pointer
